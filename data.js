...
const DATA = {
  ...
  talks: [
    ...
    {id:"T1",title:{en:"Autonomous Manufacturing Powered by Humanoid Robotics Technologies",ko:"휴머노이드 로보틱스 기술 기반 자율제조"},venue:{en:"2024 Symposium on KR-SG R&D Matchmaking (SKSRM), Singapore",ko:"2024 한국-싱가포르 R&D 매치메이킹 심포지엄 (SKSRM), 싱가포르"},date:{en:"Oct. 28-30, 2024",ko:"2024.10.28-30"}}
  ],
